...
import img from "../../assets/ngele.jpeg";
import { AboutMe } from "../../components";
import { DownloadCVButton } from "../../components/buttons";
import cv from "../../assets/cv/NGALEKA ANOYOLO.pdf";
import letter from "../../assets/cv/ngaleka Anoyolo.pdf";
    ...
    <AboutMe>
      <AboutMe.Container>
        ...
        <AboutMe.Column>
          ...
          <AboutMe.Heading4>
            Hello! My Name is Ngaleka Anoyolo.
          </AboutMe.Heading4>
          <AboutMe.Text>
